...
if MESSAGE is None:
   MSG = '''
Hii There..
I am ᴅᴇᴀᴅ𝕏 , Assistant of my Master😊
else:
  MSG = MESSAGE
botnickname = os.environ.get("BOT_NICK_NAME")
ALIVE_NAME = os.environ.get("ALIVE_NAME")
BOT = str(botnickname) if botnickname else "ᴅᴇᴀᴅ𝕏"
NAME = str(ALIVE_NAME) if ALIVE_NAME else "ᴅᴇᴀᴅ𝕏"
...
MASTER = NAME
GROUP = "[𝗗𝗘𝗔𝗗 ɴᴇᴛᴡᴏʀᴋ](https://t.me/DeadNetwork)"
